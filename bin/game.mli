module Game_kind : sig
    type t =
      | Trivia    
      (* Player.t list is the list of player(s) who will be participating in that minigame  *)
      
      (* this list WILL be revised when the minigames have been actually created *)
